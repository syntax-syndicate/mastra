 ...
 * This prompt helps users construct valid filters for Weaviate Vector.
 */
...
- $all: Match arrays containing all values
  Example: { "tags": { "$all": ["sale", "new"] } }
...
Element Operators:
- $exists: Check if field exists (is not null)
