...
export const identityInvestigator = createIdentityInvestigator(process.env.MASTRA_MODEL ?? 'openai/gpt-4o-mini');

export const invokeIdentityInvestigator: InvestigatorInvoker = async (input, _attempt, signal) =>
  (
