...
export const endpointInvestigator = createEndpointInvestigator(process.env.MASTRA_MODEL ?? 'openai/gpt-4o-mini');

export const invokeEndpointInvestigator: InvestigatorInvoker = async (input, _attempt, signal) =>
  (
