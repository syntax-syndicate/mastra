...
- Removed thread-group responses from `queryTraces()`. The client now accepts trace-only queries and returns trace records. ([#23923](https://github.com/mastra-ai/mastra/pull/23923))
