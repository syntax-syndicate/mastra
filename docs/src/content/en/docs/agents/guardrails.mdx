...
description: "Protect Mastra agents with built-in guardrail processors for prompt injection, content moderation, PII redaction, Unicode normalization, and output safety."
packages:
  - "@mastra/core"
---
...
```typescript {7-13} title="src/mastra/agents/secure-agent.ts"
