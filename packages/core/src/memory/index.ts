...
export abstract class MastraMemory {
     ...
     */
    async createThread({ threadId, resourceid, title, metadata }: { resourceid: string, threadId?: string, title?: string, metadata?: Record<string, unknown> }): Promise<ThreadType> {
