  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: 'text-neutral6 font-medium',
        nav: 'flex items-center',
        nav_button_previous:
          'flex size-7 items-center justify-center rounded-md bg-transparent p-0 text-neutral3 hover:bg-neutral6/5 hover:text-neutral6',
        nav_button_next:
          'flex size-7 items-center justify-center rounded-md bg-transparent p-0 text-neutral3 hover:bg-neutral6/5 hover:text-neutral6',
        ...
        day_today: 'bg-neutral6/10 text-neutral6',
        day_outside:
          'day-outside text-neutral3 opacity-50 aria-selected:bg-neutral6/5 aria-selected:text-neutral3 aria-selected:opacity-30',
        day_disabled: 'text-neutral3 opacity-50',
        day_range_middle: 'aria-selected:bg-neutral6/10 aria-selected:text-neutral6',
