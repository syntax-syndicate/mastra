...
export const ConversationTimeline: Story = {
  render: args => (
    <div className="flex h-80 w-112 items-center rounded-xl border border-border bg-background px-10">
      <ThreadRail {...args} maxHeight="16rem" />
      <p className="ml-10 text-caption text-muted-foreground">Hover or focus a rail stop to preview that turn.</p>
    </div>
  ),
};
...
export const Empty: Story = {
  args: { turns: [] },
  render: args => (
    <div className="h-40 w-80 rounded-xl border border-dashed border-border">
      <ThreadRail {...args} />
    </div>
  ),
};
