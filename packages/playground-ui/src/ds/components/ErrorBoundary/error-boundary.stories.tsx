...
function ScopedBoundaryDemo() {
  return (
    <div className="grid h-105 w-180 grid-cols-[200px_1fr] gap-4 rounded-lg border border-border p-3">
      <aside className="flex flex-col gap-2 rounded-md bg-card p-3">
...
export const SectionVariantSmallParent: Story = {
  ...
  render: () => (
    <div className="h-65 w-95 rounded-lg border border-border">
      <ErrorBoundary>
        <Bomb shouldThrow />
      </ErrorBoundary>
    </div>
...
export const SectionVariantLargeParent: Story = {
  ...
  render: () => (
    <div className="h-140 w-220 rounded-lg border border-border">
      <ErrorBoundary>
        <Bomb shouldThrow />
      </ErrorBoundary>
    </div>
...
export const InlineVariant: Story = {
  ...
  render: () => (
    <div className="h-105 w-180 rounded-lg border border-border p-4">
