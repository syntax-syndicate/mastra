...
export const Default: Story = {
  render: () => (
    <HoverCard>
      <HoverCardTrigger className="text-body text-foreground cursor-help underline">Hover me</HoverCardTrigger>
...
export const WithButtonTrigger: Story = {
  render: () => (
    <HoverCard>
      <HoverCardTrigger render={<button type="button" />} className="text-body text-foreground cursor-help underline">
        Agent details
      </HoverCardTrigger>
...
export const WithRichContent: Story = {
  render: () => (
    <HoverCard>
      <HoverCardTrigger className="text-body text-foreground cursor-help underline">Weather Agent</HoverCardTrigger>
...
export const BottomNoArrow: Story = {
  render: () => (
    <HoverCard>
      <HoverCardTrigger className="text-body text-foreground cursor-help underline">Open below</HoverCardTrigger>
