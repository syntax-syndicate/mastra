  ...
  return (
    <li
      ...
      className={cn(
        ...
        transitions.colors,
        'outline-hidden hover:bg-fill-subtle focus-visible:bg-fill-subtle focus-visible:text-foreground focus-visible:outline-hidden',
        isSelected && 'bg-fill-hover text-foreground',
        className,
      )}
