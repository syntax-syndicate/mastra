  ...
  return (
    <li
      ...
      className={cn(
        ...
        transitions.colors,
        'outline-hidden hover:bg-surface4 focus-visible:bg-surface4 focus-visible:text-foreground focus-visible:outline-hidden',
        isSelected && 'bg-surface4 text-foreground',
        className,
      )}
