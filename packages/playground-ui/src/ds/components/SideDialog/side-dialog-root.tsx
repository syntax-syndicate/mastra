    ...
    >
      <DrawerPortal>
        ...
        <DrawerViewport className={isConfirmation ? 'pointer-events-none' : undefined}>
          <DrawerPopup
            className={cn(
              'max-w-none overflow-visible rounded-none border-y-0 border-r-0 border-l border-border-strong bg-background',
              {
              ...
              <DrawerClose
                render={
                  <button
                    type="button"
                    className={cn(
                      'absolute top-0 -left-14 flex size-14 appearance-none items-center justify-center rounded-bl-lg border-b border-l border-border-strong bg-background text-muted-foreground',
                      transitions.all,
